...
class TablaPdpsSheet implements FromCollection, WithHeadings,WithColumnFormatting,WithStyles,WithStrictNullComparison,ShouldAutoSize
{
    ...
    public function collection()
    {
        ...
        $res=Reporte::generarTablaPdps($this->rq);
