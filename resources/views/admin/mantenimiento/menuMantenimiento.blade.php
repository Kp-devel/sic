<div>
    ...
    <div class="menu-option">
        ...
        <div class="collapse" id="submenuEmpleado" class="bg-blue-bold">
            <a href="{{route('smslistanegranumero')}}" class="bg-blue-bold text- px-5 waves-effect {{ request()->is('smslistanegranumero') ? 'menu-active' : '' }}">Registrar Empleado</a>
            <a href="{{route('smslistanegraarchivo')}}" class="bg-blue-bold text- px-5 waves-effect {{ request()->is('smslistanegraarchivo') ? 'menu-active' : '' }}">Lista de Empleados</a>
        </div>
        <!-- getores -->
